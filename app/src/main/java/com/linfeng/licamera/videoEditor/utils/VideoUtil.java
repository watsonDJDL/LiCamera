...
import com.linfeng.licamera.videoEditor.model.LocalVideoModel;
...
public class VideoUtil {
    ...
    private static final int thumb_Width = (CommonUtil.getScreenWidth() - CommonUtil.dip2px(16)) / VIDEO_MAX_DURATION;
    private static final int thumb_Height = CommonUtil.dip2px(62);
